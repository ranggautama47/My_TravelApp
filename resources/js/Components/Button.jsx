        ...
        <>
           ...
           {type === "submit" && (
            ...
            {type === "cancel" && (
                <Link
                    href={url}
                    className="px-4 py-2 text-sm rounded-lg border border-rose-500 flex items-center gap-2 hover:bg-rose-100"
                >
            ...
            {type === "button" && (
                <button
                    {...props}
                    type="button"
                    className={`px-4 py-2 text-sm rounded-lg flex items-center gap-2 ${className}`}
                >
                    {children}
                </button>
            )}
